...
const menuItems = [
  {
    ...
    name: "Greek coffee",
    price: "2.00",
    description: "Traditional Greek coffee served rich, aromatic, and comforting.",
  ...
  },
  {
    ...
    price: "3.00",
    description: "A larger traditional Greek coffee with a bold finish.",
    ingredients: "Greek coffee, water, optional sugar.",
    allergens: "No common allergens. Ask staff about cross-contact.",
    sizes: "Double cup.",
    image: "",
  ...
  },
  {
    ...
    name: "Espresso",
    price: "2.00",
    description: "Short, intense espresso with a clean crema.",
  ...
  },
  {
    ...
    price: "3.00",
    description: "Two shots of espresso for a stronger coffee moment.",
    ingredients: "Espresso coffee.",
    allergens: "No common allergens. Ask staff about cross-contact.",
    sizes: "Double shot.",
    image: "",
